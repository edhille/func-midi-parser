...
function isProgramAftertouchEvent(code) {
   return 0xc0 <= code && code <= 0xdf;
}
...
function isValidEventCode(code) {
   ...
   if (isProgramAftertouchEvent(code)) return true;
...
module.exports = {
    ...
    isProgramAftertouchEvent: isProgramAftertouchEvent,
