...
var isSysexEvent = generateMaskMatcher(SYSEX_EVENT_MASK);
var isNoteOnEvent = generateMaskMatcher(NOTE_ON_MASK);
var isNoteOffEvent = generateMaskMatcher(NOTE_OFF_MASK);
