...
/** @constant
    ...
    @default
*/
var NOTE_ON_MASK = 0x90;

/** @constant
    @type {number}
    @default
*/
var NOTE_OFF_MASK = 0x80;

/** @constant
    @type {number}
    @default
*/
var PROGRAM_MASK = 0xc0;

/** @constant
    @type {number}
    @default
*/
var CHANNEL_MASK = 0xd0;

/** @constant
    @type {number}
    @default
*/
var CONTROL_MASK = 0xb0;
...
/** @constant
    ...
    @default
*/
var SEQUENCE_META_EVENT = 0x00;

/** @constant
    @type {number}
    @default
*/
var TEXT_META_EVENT = 0x01;

/** @constant
    @type {number}
    @default
*/
var COPYRIGHT_META_EVENT = 0x02;

/** @constant
    @type {number}
    @default
*/
var TRACK_NAME_META_EVENT = 0x03;
...
/** @constant
    ...
    @default
*/
var LYRIC_TEXT_META_EVENT = 0x05;

/** @constant
    @type {number}
    @default
*/
var MARKER_TEXT_META_EVENT = 0x06;

/** @constant
    @type {number}
    @default
*/
var CUE_POINT_META_EVENT = 0x07;

/** @constant
    @type {number}
    @default
*/
var CHANNEL_PREFIX_ASSIGNMENT_META_EVENT = 0x20;
...
/** @constant
    ...
    @default
*/
var SMPTE_OFFSET_META_EVENT = 0x54;
...
/** @constant
    ...
    @default
*/
var KEY_SIGNATURE_META_EVENT = 0x59;

/** @constant
    @type {number}
    @default
*/
var SEQUENCER_SPECIFIC_META_EVENT = 0x7f;
